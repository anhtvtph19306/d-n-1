...
if (isset($_POST["dangnhap"])) {
  $err=[];
  if (empty($_POST["user"])) {
      $err["user"]="Không được để trống ô user name";
  }else {
      $user = $_POST["user"];
  }
        ...
        <div class="row d-flex justify-content-center">
          ...
          <div class="col-md-6">
            ...
            <form class="text-center" action="index.php?act=dangnhap" method="post">
              ...
              <p class="h4 mb-4"><a href="index.php" style="margin-right:60px; color:black"><i class="fa-solid fa-house"></i></a> Đăng nhập</p>
              ...
              <div class="form-row mb-4">
                <div class="col">
                  ...
                  <span><?php if(!empty()) echo $err["user"];?></span>
                </div>
